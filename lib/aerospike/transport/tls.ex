defmodule Aerospike.Transport.Tls do
  ...
  """
  @impl true
  @spec stream_read(Tcp.stream(), non_neg_integer()) ::
          {:ok, binary()} | :done | {:error, Error.t()}
  ...
  """
  @impl true
  @spec stream_close(Tcp.stream()) :: :ok
