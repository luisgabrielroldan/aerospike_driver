defmodule Demo.Examples.ListMap do
  ...
  defp test_list_strings do
    ...
    :ok = Aerospike.put!(@conn, key, %{"listbin1" => list})
  ...
  defp test_list_complex do
    ...
    :ok = Aerospike.put!(@conn, key, %{"listbin2" => list})
  ...
  defp test_map_strings do
    ...
    :ok = Aerospike.put!(@conn, key, %{"mapbin1" => map})
  ...
  defp test_map_complex do
    ...
    :ok = Aerospike.put!(@conn, key, %{"mapbin2" => map})
  ...
  defp test_list_map_combined do
    ...
    :ok = Aerospike.put!(@conn, key, %{"listmapbin" => list})
