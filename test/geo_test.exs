defmodule Aerospike.GeoTest do
  ...
  describe "Point" do
    ...
    test "enforce_keys prevents bare point struct construction" do
  ...
  describe "Polygon" do
    ...
    test "supports empty polygons" do
  ...
  describe "Circle" do
    test "builds a circle with numeric radius" do
      assert %Geo.Circle{lng: -122.0, lat: 45.0, radius: 5_000.0} = Geo.circle(-122, 45, 5_000)
    end
  ...
  describe "encoding" do
    test "encodes point to GeoJSON" do
      ...
      decoded = point |> Geo.to_json() |> Jason.decode!()
    ...
    test "encodes polygon to GeoJSON" do
      ...
      decoded = polygon |> Geo.to_json() |> Jason.decode!()
    ...
    test "encodes circle to AeroCircle GeoJSON" do
      ...
      decoded = circle |> Geo.to_json() |> Jason.decode!()
